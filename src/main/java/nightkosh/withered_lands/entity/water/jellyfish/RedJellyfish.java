 ...
 */
public class RedJellyfish extends AJellyfish {

    public RedJellyfish(EntityType<? extends AJellyfish> entityType, Level level) {
    ...
    protected void applyEffect(LivingEntity entity) {
        ...
        if (WLConfigs.RED_JELLYFISH_WITHER_DEBUFF.get()) {
