 ...
 */
public class WhiteJellyfish extends AJellyfish {

    public WhiteJellyfish(EntityType<? extends AJellyfish> entityType, Level level) {
    ...
    public static boolean checkSpawnRules(
        ...
        return WLConfigs.WHITE_JELLYFISH_SPAWN.get() &&
                checkCommonSpawnRules(levelAccessor, blockPos, random, WhiteJellyfish.class);
    }
