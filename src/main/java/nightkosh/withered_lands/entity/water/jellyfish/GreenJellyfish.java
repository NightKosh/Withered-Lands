 ...
 */
public class GreenJellyfish extends AJellyfish {

    public GreenJellyfish(EntityType<? extends AJellyfish> entityType, Level level) {
    ...
    public static boolean checkSpawnRules(
        ...
        return WLConfigs.GREEN_JELLYFISH_SPAWN.get() &&
                checkCommonSpawnRules(levelAccessor, blockPos, random, GreenJellyfish.class);
    }
