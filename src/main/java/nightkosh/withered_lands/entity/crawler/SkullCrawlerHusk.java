 ...
 */
public class SkullCrawlerHusk extends SkullCrawlerZombie {

    public SkullCrawlerHusk(EntityType<? extends ASkullCrawler> entityType, Level level) {
        super(entityType, level);
    }

    @Override
    public Block getPilesOfBones() {
        return PILE_OF_BONES_SKULL_HUSK_CRAWLER;
    }

    @Override
    public Block getBoneSkullBlock() {
        return BONE_BLOCK_SKULL_HUSK_CRAWLER;
    }
