 ...
 */
public class ParchedSkullCrawler extends SkeletonSkullCrawler {

    public ParchedSkullCrawler(EntityType<? extends ASkullCrawler> entityType, Level level) {
        super(entityType, level);
    }

    @Override
    public Block getPilesOfBones() {
        return PILE_OF_BONES_SKULL_PARCHED_CRAWLER;
    }
    ...
    protected void applyEffect(LivingEntity entity) {
        entity.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, TimeHelper.SECONDS_5), this);
    }
