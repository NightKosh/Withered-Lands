 ...
 */
public class JellyfishRedModel<T extends JellyfishRenderState> extends AJellyfishModel<T> {

    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            fromNamespaceAndPath(ModInfo.ID, "red_jellyfish"), "main");
    ...
    public JellyfishRedModel(ModelPart root) {
        super(root);
