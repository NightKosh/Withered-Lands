 ...
 */
public class BlizzardRenderer extends ABreezeRenderer {

    public BlizzardRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void addWindLayer(ABreezeRenderer renderer, EntityModelSet modelSet) {
        this.addLayer(new BlizzardWindLayer(this, modelSet));
    }

    @Override
    protected void addEyeLayer(ABreezeRenderer renderer, EntityModelSet modelSet) {
        this.addLayer(new BlizzardEyesLayer(this, modelSet));
    }

    @Nonnull
    @Override
    public Identifier getTextureLocation(BreezeRenderState state) {
        return WLTextures.BLIZZARD;
    }
