 ...
 */
public abstract class HostileBatRender extends MobRenderer<HostileBat, BatRenderState, BatModel> {
    ...
    @Override
    public void extractRenderState(HostileBat bat, BatRenderState state, float xz) {
