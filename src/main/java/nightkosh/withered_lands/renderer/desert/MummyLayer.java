 ...
 */
public class MummyLayer extends RenderLayer<ZombieRenderState, HumanoidModel<ZombieRenderState>> {

    private final HumanoidModel model;

    public MummyLayer(RenderLayerParent<ZombieRenderState, HumanoidModel<ZombieRenderState>> renderer, EntityModelSet modelSet) {
        super(renderer);
    ...
    public void submit(@Nonnull PoseStack poseStack, @Nonnull SubmitNodeCollector nodeCollector,
        ...
        coloredCutoutModelCopyLayerRender(
                this.model, WLTextures.MUMMY_OVERLAY,
