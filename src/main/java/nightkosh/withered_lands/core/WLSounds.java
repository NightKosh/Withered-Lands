...
public class WLSounds {
    ...
    // Mummy
    public static final DeferredHolder<SoundEvent, SoundEvent> MUMMY_AMBIENT =
            registerSoundEvent("mummy_ambient", "entity.mummy.ambient");
